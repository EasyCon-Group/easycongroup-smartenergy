package uz.easycongroup.smartenergy.data.datasource.rest.retrofit.adapter
...
import uz.easycongroup.smartenergy.data.datasource.rest.retrofit.callback.awaitCallback
...
internal object FlowCallAdapterFactory : CallAdapter.Factory() {
    ...
    override fun get(
        ...
        return object : CallAdapter<Any, Any> {
            override fun adapt(call: Call<Any>): Flow<Any> = flow { emit(call.awaitCallback()) }
