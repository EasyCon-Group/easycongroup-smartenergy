 ...
 * @property skipItems количество элементов для которых нужно пропускать рисование индикатора
...
class ScaleLinePageIndicatorDecoration(
    ...
    private val widthActive: Int = 24.toPx,
    private val paddingBetween: Int = 8.toPx,
    private val indicatorHeight: Int = 8.toPx,
    private val indicatorRadius: Int = 8.toPx,
    private val paddingTop: Int = 0.toPx,
    private val paddingBottom: Int = 0,
    private val paddingHorizontal: Int = 16.toPx,
    private val skipItems: Int = 0,
    @ColorInt val colorActive: Int = 0xffffff,
    @ColorInt val colorInactive: Int = 0xffffff
    ...
    override fun draw(
        ...
        val itemsCount = adapter.itemCount - skipItems
