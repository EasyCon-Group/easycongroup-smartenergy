...
class HorizontalLinearDividerDecorator(
    gap: Gap
...
//        val startX = recyclerView.paddingLeft + paddingStart
        val startX = view.paddingLeft + paddingStart
...
//        val stopX = view.width - view.paddingRight - paddingEnd
        val stopX = view.width - paddingEnd
        val stopY = startY
