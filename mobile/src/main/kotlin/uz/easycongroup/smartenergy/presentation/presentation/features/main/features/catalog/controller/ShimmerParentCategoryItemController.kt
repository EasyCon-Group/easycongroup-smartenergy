package uz.easycongroup.smartenergy.presentation.presentation.features.main.features.catalog.controller
...
class ShimmerParentCategoryItemController : NoDataItemController<BaseViewHolder>() {

    override fun createViewHolder(parent: ViewGroup?) =
        BaseViewHolder(parent, R.layout.view_holder_catalog_parent_category_shimmer).apply {
